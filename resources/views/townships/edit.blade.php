        ...
        <div class="card border-0 mx-auto" style="max-width: 700px; border-radius: 16px; box-shadow: 0 4px 28px rgba(16, 92, 58, 0.11); overflow: hidden;">
            <div class="card-header bg-success text-white py-3 px-4">
                <h5 class="mb-0 fw-bold">
                    <i class="fas fa-city me-2"></i>မြို့နယ်များ ပြင်ဆင်ရန်
                </h5>
            </div>
            ...
            <div class="card-body" style="padding: 24px 28px;">
                ...
                <form method="POST" action="{{ route('townships.update', $township->id) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="hidden" name="is_active" id="is_active" value="{{ $township->is_active }}">
                        <div id="statusToggle" class="status-switch {{ $township->is_active ? 'active' : '' }}">
                            <div class="status-knob"></div>
                        </div>
                    </div>

                    <div class="tb-form-footer">
                        <a href="{{ route('townships.index') }}" class="btn-back">
