...
@section('content')
    <div class="container-fluid py-4 px-4">
        <div class="card border-0 mx-auto" style="max-width: 900px; border-radius: 16px; box-shadow: 0 4px 28px rgba(16, 92, 58, 0.11); overflow: hidden;">
            <div class="card-header bg-success text-white py-3 px-4">
                <h5 class="mb-0 fw-bold">
                    <i class="fas fa-layer-group me-2"></i>အတန်းများ ဖန်တီးရန်
                </h5>
            </div>
            ...
            <div class="card-body" style="padding: 24px 28px;">
                <style>
                    ...
                    .status-switch.active { background: #198754; }
                    .status-knob {
                    ...
                    .tb-form-footer {
                        ...
                        margin: 24px -28px -24px -28px; padding: 16px 28px;
                ...
                <form method="POST" action="{{ route('grades.store') }}">
                    ...
                    <h6 class="fw-bold mb-3" style="color:#105c3a;">
