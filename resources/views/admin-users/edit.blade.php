                ...
                <form method="POST" action="{{ route('admin-users.update', $user->id) }}">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="position-relative">
                                <input type="password" id="password" name="password" class="form-control @error('password') is-invalid @enderror" style="padding-right: 42px;" placeholder="မပြောင်းလဲပါက ချန်ထားပါ">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <div class="position-relative">
                                <input type="password" id="password_confirmation" name="password_confirmation" class="form-control" style="padding-right: 42px;" placeholder="စကားဝှက်အသစ် ပြန်လည်ရိုက်ထည့်ပါ">
