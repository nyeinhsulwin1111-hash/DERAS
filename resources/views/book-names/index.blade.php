    ...
    <div class="app-page-container">
        ...
        <div class="modern-card">
            ...
            <div class="modern-card-body p-4 sm:p-6">
                <form method="GET" action="{{ route('book-names.index') }}" class="m-0">
                    <div class="flex flex-wrap items-end gap-3">
                        <div style="flex: 2; min-width: 200px;">
                            <label class="block text-sm font-extrabold mb-1.5" style="color: #105c3a;">ဘာသာရပ် ရှာဖွေရန်</label>
                            <div class="relative">
                                ...
                                <input type="text" name="search" class="modern-input text-sm font-medium" style="padding-left: 2.25rem;"
                                    placeholder="ဘာသာရပ်ရှာဖွေရန်..." value="{{ request('search') }}">
                            </div>
                        </div>
                        ...
                        <div class="flex items-end gap-2" style="padding-bottom: 1px;">
                            ...
                            <a href="{{ route('book-names.index') }}" class="btn-modern-secondary">
                                <i class="fas fa-redo"></i>
                                ပြန်လည်သတ်မှတ်
                            </a>

                            <a href="{{ route('book-names.create') }}" class="btn-modern-primary">
        ...
        <div class="modern-table-container mt-4">
            <table class="modern-table">
                ...
                <tbody>
                    @forelse($bookNames as $key => $bookName)
                        <tr>
                            ...
                            <td>
                                <div class="inline-flex items-center gap-2 justify-center">
                                    <a href="{{ route('book-names.edit', $bookName->id) }}" class="btn-modern-warning" title="ပြင်ဆင်ရန်">
                                        <i class="fas fa-pen"></i>
                                    </a>

                                    @if (auth()->user()?->role === 'super')
                                        <form action="{{ route('book-names.destroy', $bookName->id) }}" method="POST"
                                            class="d-inline m-0">
                                            @csrf
                                            @method('DELETE')
